...
public final class Encoder implements Visitor {
    ...
    public Object visitElseIfCommand(ElseIfCommand ast, Object o) { //TODO :add else if command to the encoder
        Frame frame = (Frame) o;
        int jumpifAddr, jumpAddr;
        Integer valSize = (Integer) ast.E.visit(this, frame);
        jumpifAddr = nextInstrAddr;
    ...
    public Object visitProcFuncDeclaration(ProcFuncDeclaration ast, Object o) { //TODO :add proc func declaration
        ...
        inRecursive = false;
        Hashtable recursiveIds = new Hashtable<String, ArrayList<Integer>>();
        return new Integer(extraSize1 + extraSize2);
    }
    ...
    public Object visitReursiveDeclaration(RecursiveDeclaration ast, Object o) { //TODO :add proc func declaration
        ...
        if (ast.D instanceof FuncDeclaration) {
            ((FuncDeclaration) ast.D).visit(this, o);

        } else if (ast.D instanceof ProcDeclaration) {
            ((ProcDeclaration) ast.D).visit(this, o);
        }
        return new Integer(0);
    }
