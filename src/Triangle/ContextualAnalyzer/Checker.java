...
public final class Checker implements Visitor {
    ...
    public Object visitCallCommand(CallCommand ast, Object o) { //add visit call command
    ...
    public Object visitLetCommand(LetCommand ast, Object o) { //add visit let command
        idTable.openScope();
    ...
    public Object visitWhileCommand(WhileCommand ast, Object o) { //add visit while command
        TypeDenoter eType = (TypeDenoter) ast.E.visit(this, null);
        if (!eType.equals(StdEnvironment.booleanType)) {
            reporter.reportError("Boolean expression expected here", "", ast.E.position);
        }
    ...
    public Object visitUntilCommand(UntilCommand ast, Object o) { //TODO :add until command to the checker
        TypeDenoter eType = (TypeDenoter) ast.E.visit(this, null); //add visit until command
        if (!eType.equals(StdEnvironment.booleanType)) {
            reporter.reportError("Boolean expression expected here", "", ast.E.position);
        }
        ast.C.visit(this, null);
    ...
    public Object visitForCommand(ForCommand ast, Object o) { //TODO :add for command to the checker
        idTable.openScope(); //add for commmand
        ast.D.visit(this, null);
        TypeDenoter eType = (TypeDenoter) ast.E.visit(this, null);
